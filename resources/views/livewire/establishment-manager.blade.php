            ...
            <div class="accordion-item">
                ...
                <div id="collapse{{ $establishment->id }}" class="accordion-collapse collapse "
                    ...
                    <div class="accordion-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <select id="cae-select" wire:model.defer="companies.{{ $index }}.cae"
                                    ...
                                    <optgroup label="Hotelaria">
                                        ...
                                        <option value="55204">55204 - Outros locais de alojamento de curta duração
                                        </option>
                                    </optgroup>
                                    ...
                                    <optgroup label="Restauração">
                                        ...
                                        <option value="56106">56106 - Confeção de refeições prontas a levar para casa
                                            (take-away)</option>
                                        <option value="56107">56107 - Restaurantes, n.e. (inclui atividades de
                                            restauração
                                            em
                                            meios móveis)</option>
                                        <option value="56210">56210 - Fornecimento de refeições para eventos</option>
                                        <option value="56290">56290 - Outras atividades de serviço de refeições
                                        </option>
                                    ...
                                    <optgroup label="Retalho">
                                        <option value="47111">47111 - Comércio a retalho em supermercados e
                                            hipermercados
                                        </option>
                                        ...
                                        <option value="47210">47210 - Comércio a retalho de frutas e produtos
                                            hortícolas,
                                            em
                                        ...
                                        <option value="47230">47230 - Comércio a retalho de peixe, crustáceos e
                                            moluscos,
                                            em
                                            estabelecimentos especializados</option>
                                        <option value="47240">47240 - Comércio a retalho de pão, produtos de pastelaria
                                            e
                                            de
                                            confeitaria, em estabelecimentos especializados</option>
                                        <option value="47250">47250 - Comércio a retalho de bebidas, em
                                            estabelecimentos
                                        ...
                                        <option value="47291">47291 - Comércio a retalho de leite e de derivados, em
                                            estabelecimentos especializados</option>
                                        <option value="47292">47292 - Comércio a retalho de açúcar, chocolate e
                                            produtos de
                                            confeitaria, em estabelecimentos especializados</option>
                                        <option value="47293">47293 - Comércio a retalho de produtos alimentares,
                                            naturais
                                            e
                                            dietéticos, em estabelecimentos especializados</option>
                                        <option value="47294">47294 - Comércio a retalho de outros produtos
                                            alimentares,
                                            n.e.,
                                            em estabelecimentos especializados</option>
                                    </optgroup>
                            ...
                            <div class="form-group col-md-6">
                                <select id="tipo-select"
                                    wire:model.defer="companies.{{ $index }}.tipo_estabelecimento"
                                    class="custom-input" style="width:100%" required>
                                    <option>Seleciona o tipo de Estabelecimento:</option>
                                    <optgroup label="tipo">
                                        <option value="Hotelaria">Hotelaria</option>
                                        <option value="Talho">Talho</option>
                                        <option value="Restaurante">Restaurante</option>
                                        <option value="Rouloute">Rouloute</option>
                                    </optgroup>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label>Número de Utilizadores:</label>
                                <input type="number" wire:model.defer="companies.{{ $index }}.n_users"
                                    class="custom-input form-control">
                            </div>
                            <div class="form-group col-md-6">
                                <label>Número de Funcionários:</label>
                                <input type="number" wire:model.defer="companies.{{ $index }}.n_funcionarios"
                                    class="custom-input form-control">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label>Titulo de Licenciamento:</label>
                                <input type="number" wire:model.defer="companies.{{ $index }}.titulo_licenciamento"
                                    class="custom-input form-control">
                            </div>
                        </div>
