<div>
    <div class="modal-body">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                <select id="cae-select" wire:model.defer="companie.cae" class="custom-input" style="width:100%"
                    required>
            ...
            <div class="form-group col-md-6">
                <select id="tipo-select" wire:model.defer="companie.tipo_estabelecimento" class="custom-input"
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="number" wire:model.defer="companie.n_funcionarios" class="custom-input form-control">
            </div>
        </div>
        <div class="form-row">
            <div class="form-group col-md-6">
