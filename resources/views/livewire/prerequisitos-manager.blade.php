            ...
            <form>
                ...
                <div class="mb-3">
                    ...
                    <a target="_blank" style="font-size: 0.6rem;"
                        href="https://fontawesome.com/search?o=r&m=free">https://fontawesome.com/search?o=r&m=free</a>
                    @error('icon')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="mb-3">
                    <label for="icon" class="form-label">Descrição</label>
                    <textarea class="form-control" id="text" wire:model="text" placeholder="Descrição" rows="5"></textarea>
                ...
                <button type="button" class="btn btn-primary" style="background-color: black; border: 0;"
                    wire:click="addFolder">Adicionar Pré-Requisito</button>
            </form>
        </div>
        <div class="col-md-6">
