<x-app-layout>
    ...
    <div class="row" style="margin-top:2%">
        <div class="col-12 d-flex justify-content-end mb-3">
            ...
            <button class="btn btn-success mr-2" style="background-color: black; border: 0;" data-toggle="modal" data-target="#cardModal">
                <i class="fas fa-plus mr-1"></i> Auditoria
            </button>
        </div>

    </div>
    <div class="row" style="margin-top:2%">
        @livewire('show-auditorias')
    </div>
