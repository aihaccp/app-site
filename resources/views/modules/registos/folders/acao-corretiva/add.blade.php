    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-7 col-md-7">
                <h4>NOVO REGISTO</h4>
                <form method="post" action="{{route('submeterRegistoAcoesCorretivas')}}" id="formRegisto">
                    @csrf
                    ...
                    <div class="row pb-2" style="margin:0">
                        <div class="input-group">
                            <textarea placeholder="Detalhar o problema detetado"
                                class="form-control form-control-lg shadow py-3" style="border:0px; font-size: 1.1rem;"
                                name="problema" rows="3" cols="50"></textarea>

                        </div>
                    </div>
                    <div class="row pb-2" style="margin:0">
                        <div class="input-group">
                            <textarea placeholder="Descrever a ação corretiva realizada ou a ser realizada!"
                                class="form-control form-control-lg shadow py-3" style="border:0px; font-size: 1.1rem;"
                                name="descricao" rows="3" cols="50"></textarea>
