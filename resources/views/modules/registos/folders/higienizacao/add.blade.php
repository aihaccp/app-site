<x-app-layout>
<div class="container">
    <h5>Home / {{$module}} @if(isset($folder)) / {{$folder}} @endif @if(isset($registo)) / {{$registo}} @endif / Novo Registo</h5>
    <div class="row">
        <div class="col-lg-7 col-md-7">
            <h4>NOVO REGISTO</h4>
            <form method="post" action="{{route('submeterRegistoHigienizacao')}}" id="formRegisto">
                @csrf
                    ...
                    <div class="card shadow" style="border-radius:10px; border:0px">
                        <div class="card-body p-2">
                            <div class="row justify-content-between">
                                <div class="col-lg-7">
                                    <h5>{{App\Models\Area::where('id',$registo->id_area)->first()->designacao}}</h5>
                                </div>
                            ...
                            <div class="row justify-content-between">
                                <div class="col-lg-7 ">
                                    ...
                                    <p class="my-0">{{ App\Models\Equipamento::where('id', $registo->id_item)->first()->nome }}</p>
                                </div>
                                <div class="col-lg-5  text-right">
